  ...
  return (
    <div>
      <div className="transform scale-75 relative top-[-220px]">
        <div className="flex flex-col justify-center items-center border-[1px] border-black w-[1600px] h-[1477px] bg-[#F7F3EF] rounded-[25px] transform scale-75 relative top-[-200px]">
          ...
          <textarea
            type="text"
            className="text-center mt-[150px] my-[105px] font-light text-[30px] leading-[66px] bg-[#F7F3EF] outline-none w-[1300px] h-[1100px] overflow-y-auto custom-scrollbar"
            value={content}
            onChange={(e) => {
